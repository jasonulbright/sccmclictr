    ...
    public class inventory : baseInit
    {
        ...
        public class AI_InstalledSoftwareCache
        {
            ...
            public string Uninstall()
            {
                ...
                {
                    return oNewBase.GetStringFromPS("& msiexec.exe /x '" + Guid.Parse(SoftwareCode).ToString("B") + "' REBOOT=ReallySuppress /q");
                }
            ...
            public string Repair()
            {
                if (SoftwareCode.StartsWith("{"))
                {
                    return oNewBase.GetStringFromPS("& msiexec.exe /fpecmsu '" + Guid.Parse(SoftwareCode).ToString("B") + "' REBOOT=ReallySuppress REINSTALL=ALL /q");
                }
