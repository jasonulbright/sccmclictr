...
namespace sccmclictr.automation.functions
{
    ...
    public class agentactions : baseInit
    {
        ...
        public bool RepairAgent()
        {
            ...
            {
                Guid productCode = Guid.Parse(sProdCode);
                string sResult = baseClient.GetStringFromPS("& msiexec.exe /fpecms '" + productCode.ToString("B") + "'");
                return true;
            }
        ...
        public bool UninstallAgent()
        {
            ...
            {
                Guid productCode = Guid.Parse(sProdCode);
                string sResult = baseClient.GetStringFromPS("& msiexec.exe /x '" + productCode.ToString("B") + "' REBOOT=ReallySuppress /q");
                return true;
            }
