...
public class CIM_ManagedSystemElement
{
  ...
  public CIM_ManagedSystemElement(PSObject WMIObject, Runspace RemoteRunspace, TraceSource PSCode)
  {
    ...
    object dmtfDate = WMIObject.Properties[nameof (InstallDate)]?.Value;
    this.InstallDate = !common.IsMissingDate(dmtfDate) ? new DateTime?(common.DmtfToDateTime(dmtfDate)) : new DateTime?();
