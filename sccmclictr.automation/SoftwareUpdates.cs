...
namespace sccmclictr.automation.functions
{
    ...
    public class softwareupdates : baseInit
    {
        ...
        {
            string sCode = "$updates = @(Get-WmiObject -Namespace 'ROOT\\ccm\\ClientSDK' -Class CCM_SoftwareUpdate -ErrorAction Stop | Where-Object { $null -ne $_.Deadline }); " +
                "if ($updates.Count -gt 0) { ([wmiclass]'ROOT\\ccm\\ClientSDK:CCM_SoftwareUpdatesManager').InstallUpdates([System.Management.ManagementObject[]]$updates) }";
